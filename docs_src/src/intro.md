...
See the [list of known Issues](known-issues.md).

## Links

- [Songs of Conquest on Steam](https://store.steampowered.com/app/867210/Songs_of_Conquest/)
- [Songs of Conquest on Gog](https://www.gog.com/en/game/songs_of_conquest)
- [Latest mod release](https://github.com/Neurrone/soc-access/releases/latest)
- [Mod GitHub repository](https://github.com/Neurrone/soc-access)
