...
namespace SongsOfConquestAccess.Adapters
{
    internal sealed class KingdomEntityOverviewAdapter
    {
        ...
        private static bool ClickCategory(KingdomEntityOverviewCategoryEntry entry)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("KingdomEntityOverviewAdapter failed to click category: " + ex.Message);
                return false;
            }
        }
        ...
        private static bool ClickBuilding(KingdomEntityOverviewClaimedEntry entry)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("KingdomEntityOverviewAdapter failed to click building row: " + ex.Message);
                return false;
            }
        }
