...
namespace SongsOfConquestAccess.Adapters
{
    internal sealed class DwellingInteractionMenuAdapter
    {
        ...
        {
            List<IPurchaseTroopsEntry> entries = GetField<List<IPurchaseTroopsEntry>>(GetPurchaseTroopsSubMenu(), CurrentEntriesField);
        ...
        internal sealed class ActiveRecruitEntry : RecruitEntry
        {
            ...
            {
                get { return BuildIdPrefix(); }
            }

            public override string TroopName
            {
                get { return ResolveTroopName(); }
            }

            public override Tooltip Tooltip
            {
                get { return BuildEntryTooltip(); }
            }

            public override string NoTroopsText
            {
                get { return GetText(GetField<UITextMesh>(_entry, NoTroopsTextField)); }
            }

            public override bool IsNoTroopsVisible
            {
                get { return IsVisible(GetField<Component>(_entry, NoTroopsContainerField)); }
            }

            public override bool IsSliderVisible
            {
                get { return IsVisible(GetSlider()); }
            }

            public override bool IsSliderEnabled
            {
                get
                {
            ...
            public override int SliderMinimum
            {
                ...
                {
                    UISlider slider = GetSlider();
                    return slider != null ? Mathf.RoundToInt(slider.SliderMinValue) : 0;
                }
            }
            ...
            public override int SliderMaximum
            {
                ...
                {
                    UISlider slider = GetSlider();
                    return slider != null ? Mathf.RoundToInt(slider.SliderMaxValue) : 0;
                }
            }
            ...
            public override bool IsPurchaseVisible
            {
                get
                {
            ...
            public override bool IsPurchaseEnabled
            {
                get
                {
                    UIButton button = GetPurchaseButton();
            ...
            public override Tooltip PurchaseTooltip
            {
                get { return Tooltip.ForComponent(GetPurchaseButton() as Component, Localization); }
            }
            ...
            public override bool IsUpgradeInPoolVisible
            {
                get
                {
                    UIButton button = GetUpgradeButton();
                    return button != null && button.Active && IsVisible(button as Component);
                }
            }

            public override bool IsUpgradeInPoolEnabled
            {
                get
                {
                    UIButton button = GetUpgradeButton();
            ...
            public override Tooltip UpgradeInPoolTooltip
            {
                get { return Tooltip.ForComponent(GetUpgradeButton() as Component, Localization); }
            }
            ...
            public override bool IsEssenceMenuVisible
            {
                get { return IsVisible(GetField<Component>(_entry, EssenceTabsField)); }
            }

            public override TroopUpgradeType CurrentEssenceVariant
            {
                get { return TroopReference.UpgradeType; }
            }
            ...
            {
                return GetField<UIButton>(_entry, UpgradeButtonField);
            }
