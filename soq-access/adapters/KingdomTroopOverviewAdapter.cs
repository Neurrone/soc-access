...
namespace SongsOfConquestAccess.Adapters
{
    internal sealed class KingdomTroopOverviewAdapter
    {
        ...
        private static bool ClickTown(KingdomTroopOverviewTownEntry entry)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("KingdomTroopOverviewAdapter failed to click town row: " + ex.Message);
                return false;
            }
        }
        ...
        private static bool ClickIncome(KingdomTroopOverviewIncomeEntry entry)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("KingdomTroopOverviewAdapter failed to click troop row: " + ex.Message);
                return false;
            }
        }
