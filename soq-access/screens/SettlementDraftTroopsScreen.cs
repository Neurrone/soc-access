...
{
    internal sealed class SettlementDraftTroopsScreen : Screen
    {
        private readonly TownInteractionMenuAdapter _adapter;

        public SettlementDraftTroopsScreen(TownInteractionMenuAdapter adapter)
        ...
        {
            ContainerWidget root = new ContainerWidget("settlement-draft-troops", "Draft troops");
            if (adapter == null)
            {
                return root;
            }
        ...
        private static void AddRecruitWidgets(
            ...
            TownInteractionMenuAdapter adapter)
        {
