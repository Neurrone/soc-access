...
namespace SongsOfConquestAccess
{
    ...
    internal static class StoryCameraFocusPatches
    {
        ...
        private static IClientAdventureFacade GetDialogueFacade(AdventureDialogueCameraManager manager)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("Failed to read dialogue camera facade: " + exception.Message);
                return null;
            }
        }
        ...
        private static object GetDialogueConverter(AdventureDialogueCameraManager manager)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("Failed to read dialogue camera converter: " + exception.Message);
                return null;
            }
        }
            ...
            AdventureDialogueCameraManager manager)
        {
            ...
            {
                SoqAccessPlugin.Instance?.LogWarning("Failed to resolve dialogue interacting wielder: " + exception.Message);
                return null;
            }
        }
