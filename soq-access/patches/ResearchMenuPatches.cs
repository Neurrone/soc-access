...
namespace SongsOfConquestAccess
{
    ...
    internal static class ResearchMenuPatches
    {
        ...
        {
            SoqAccessPlugin.Instance?.ScreenDetector?.OnResearchMenuReady(__instance);
        }
        ...
        {
            SoqAccessPlugin.Instance?.ScreenDetector?.OnResearchMenuClosed(__instance);
        }
        ...
        {
            SoqAccessPlugin.Instance?.ScreenDetector?.OnResearchMenuChanged(__instance);
        }
    }
}
