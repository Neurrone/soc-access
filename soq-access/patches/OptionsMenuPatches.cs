...
namespace SongsOfConquestAccess.Patches
{
    ...
    internal static class OptionsMenuPatches
    {
        ...
        private static void OptionsMenuTryClosePrefix(OptionsMenu __instance)
        {
            ...
            SoqAccessPlugin.Instance?.ScreenDetector?.OnOptionsMenuClosed(__instance);
        }
        ...
        private static void OptionsMenuDrawContentPostfix(OptionsMenu __instance)
        {
            ...
            SoqAccessPlugin.Instance?.ScreenDetector?.OnOptionsMenuChanged(__instance);
        }
        ...
        {
            yield return null;
            SoqAccessPlugin.Instance?.ScreenDetector?.OnOptionsMenuReady(menu);
        }
    }
}
