...
namespace SongsOfConquestAccess.Patches
{
    ...
    internal static class QuitToDesktopPopupPatches
    {
        ...
        {
            SoqAccessPlugin.Instance?.ScreenDetector?.OnQuitToDesktopPopupReady(__instance);
        }
        ...
        {
            SoqAccessPlugin.Instance?.ScreenDetector?.OnQuitToDesktopPopupClosed(__instance);
        }
    }
}
