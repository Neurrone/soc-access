...
{
    internal sealed class AdventureLobbyPlayerSettingsScreen : Screen
    {
        ...
        internal static LobbyPlayerSettingsMenu FindActiveMenu(LobbyPlayerSettingsMenu targetMenu)
        {
