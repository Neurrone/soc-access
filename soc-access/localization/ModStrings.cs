namespace SongsOfConquestAccess.Localization
{
    public static class ModStrings
    {
        ...
        public static class Actions
        {
            ...
            public static readonly ModString ScannerJumpToResultAlternate = new ModString("Actions.ScannerJumpToResultAlternate", "Jump To Scanner Result (Alternate)");
            ...
            public static readonly ModString ToggleBookmarkBeacon = new ModString("Actions.ToggleBookmarkBeacon", "Toggle Audio Beacon For Bookmark {0}");
